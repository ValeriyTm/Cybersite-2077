...
- **React-Testing-Library:** библиотека для тестирования React-компонентов, позволяющая тестировать приложение так, как его видит пользователь, а не проверять внутренности кода.
- **Vitest:**
- **Cypress:**
- **Storybook:**
- **Chromatic:**
