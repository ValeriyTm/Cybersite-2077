    ...
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        ...
        <div>
          ...
          <ol>
            <li>
              Использовать один из существующих общедоступных тестовых аккаунтов (перечень смотри ниже).
            </li>
            <li>
              Если вы хотите индивидуальный аккаунт, то можете связаться со мной и я создам его для вас, а затем передам реквизиты.
            </li>
          </ol>
          <p className={styles.text}>Прямая регистрация с вашим email на сайте запрещена во избежание нарушения 152 ФЗ.</p>
        </div>
        ...
        <p className={styles.text}>Перечень доступных для тестирования аккаунтов (сохраните себе):</p>
