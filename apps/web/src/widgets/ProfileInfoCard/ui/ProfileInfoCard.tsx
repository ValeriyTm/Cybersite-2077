			...
			<form onSubmit={handleSubmit(onSubmit, onFormError)}>
				<div className={styles.card}>
					...
					<div className={styles.row}>
						...
						<div className={styles.value}>
							{isEditing ? (
								<Input registration={register("name")} error={errors.name} label="Поле ввода имени" visuallyHidden />
							) : (
								<span>{user?.name}</span>
							)}
						</div>
				...
				{isEditing && (
					<div className={styles.actions}>
						...
						<Button type="submit" variant="primary" isLoading={isSubmitting} loadingText="Сохраняем...">
							Сохранить
						</Button>
					</div>
				)}
