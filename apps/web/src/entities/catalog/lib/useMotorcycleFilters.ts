...
export const useMotorcycleFilters = () => {
  ...
  const filters = {
    ...
    minYear: Number(searchParams.get("minYear")) || undefined,
    maxYear: Number(searchParams.get("maxYear")) || undefined,
    minDisplacement: Number(searchParams.get("minDisplacement")) || undefined,
    maxDisplacement: Number(searchParams.get("maxDisplacement")) || undefined,
    minPower: Number(searchParams.get("minPower")) || undefined,
