...
export class AuthService {
  ...
  async deleteAccount(userId: string, password: string) {
    ...
    //4) Удаляем пользователя, связанные с ним сессии, избранное и персональные скидки, а также обнуляем (не критичные) данные в заказах, тикетах и использованных промокодах:
