...
//Используем старый формат библиотек (require) в современном проекте на ES-модулях:
...
const { authenticator } = require("@otplib/preset-default"); //В новых версиях otplib для Node.js 16+ импорт выглядит именно так.
