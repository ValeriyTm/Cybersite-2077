...
import security from "eslint-plugin-security"; //Обнаруживает потенциально опасные паттерны (использование eval(), dangerouslySetInnerHTML, регулярные выражения, подверженные DoS).
...
export default tseslint.config(
  ...
  //Подключаем готовые конфигурации SonarJS и Security:
